            ...
            <div class="card card-body mb-3">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <span class="badge badge-secondary mb-3">Followers : ${user.public_gists }</span>
                        <span class="badge badge-success mb-3">Public Repos : ${user.followers}</span>
                        <span class="badge badge-info mb-3">Public Repos : ${user.following}</span>
                        <br><br>
                        <ul class="list-group">
                            <li class="list-group-item">Company : ${user.company}</li>
                            <li class="list-group-item">Website/Blog : ${user.company}</li>
                            <li class="list-group-item">Location : ${user.location}</li>
                            <li class="list-group-item">Member Since : ${user.created_ath}</li>
                        </ul>
                    </div>
                </div>
            </div>
